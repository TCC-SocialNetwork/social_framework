  ...
  RSpec.describe RouteHelper, type: :helper do
    ...
    describe "Get near points" do
      before(:each) do
        ...
        locations = [{latitude: -15.797780000000001, longitude: -47.866920000000007},
        ...
        @route1 = user1.add_route("route1", locations)
        
        locations = [{latitude: -15.795940000000002, longitude: -47.866440000000004},
        ...
        @route2 = user2.add_route("route2", locations)
      end
